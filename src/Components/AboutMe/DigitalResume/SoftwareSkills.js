...
const SoftwareSkills = ({ ID = 0 }) => {
    const skills = ["MATLAB | SIMULINK", "Unity", "Autodesk Inventor", "VICON Software", "MQTT", "Embedded C", "C | C++ | C#", "Ladder Logic", "Siemens TIA Portal", "Allen Bradley CCW", "Python | Micro Python", "REACT.JS", "HTML | CSS | SQL"];
